...
# The driectories where everything is and should be located.
...
video = NS(
	...
	# AV1 Configuration
	AV1 = NS(
		cpu_used = "1" # 0 == slow + higher quality, 8 == fast + lower quality
	)
)
...
_AV1 = Type("opus", "av1", "mkv", "'video/x-matroska;codecs=\"av1,opus\"'")
