...
<html>
	...
	<body>
		...
		<li>Videos must be WebM files encoded with the VP8 or VP9 codec and Vorbis audio</li>
		...
		<li>Using the encoding settings provided <a href="">here</a> does <strong>not</strong> guarantee that your encode will be perfect</li>
		</ul>
